...
const BosmanMain: React.FC = () => { // Define components: reservations, messages, prices, logged in users
  ...
  const hourlyRate = 2.0; // Define the hourly rate for parking
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-10 animate-fade-in">
      ...
      <div>
        <h1 className="text-5xl font-bold mb-4 text-blue-700 transition-transform hover:scale-105 duration-300">
          Welcome to Bosman Parking
        </h1>
        <p className="text-lg leading-relaxed mb-6">
          Secure, convenient, and affordable parking solutions at the heart of the city.
        </p>
        ...
        <p className="text-lg font-semibold mb-4 text-gray-800">
          Hourly Rate: <span className="text-blue-700 font-bold">2.00 BAM</span>
        </p>
        <a
          href="https://www.google.com/maps/place/PARKING+BOSMAN/@43.8547453,18.4040408,17z/data=!3m1!4b1!4m6!3m5!1s0x4758c9cca5aeca3f:0xbb40bb951afa88ff!8m2!3d43.8547453!4d18.4066157!16s%2Fg%2F11l35l2xjh?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D"
          target="_blank"
